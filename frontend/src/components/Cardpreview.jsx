...
//     return (
//         <Badge.Ribbon
//             text={discountPercent ? `-${discountPercent}%` : ""}
//             color="red"
//             style={{
//                 fontWeight: 700,
//                 fontSize: 13,
//                 visibility: discountPercent ? "visible" : "hidden",
//             }}
//         >
//             <Card
//                 hoverable
...
//                                 type="text"
//                                 shape="circle"
//                                 icon={<EyeOutlined style={{ color: "#555", fontSize: 16 }} />}
//                                 style={{
//                                     position: "absolute",
//                                     top: 10,
//                                     right: discountPercent ? 50 : 10,
//                                     background: "rgba(255,255,255,0.85)",
//                                     backdropFilter: "blur(4px)",
//                                     boxShadow: "0 2px 8px rgba(0,0,0,0.1)",
//                                 }}
...
//                     level={5}
//                     ellipsis={{ rows: 2 }}
//                     style={{ margin: "4px 0 8px", fontSize: 14, lineHeight: "1.4", minHeight: 40 }}
//                 >
//                     {book?.book_name || "Tên sách"}
//                 </Title>

//                 <Space align="center" style={{ marginBottom: 10 }}>
//                     <Rate disabled allowHalf defaultValue={book?.review_star || 0} style={{ fontSize: 12, color: "#faad14" }} />
//                     <Text type="secondary" style={{ fontSize: 12 }}>
//                         Đã bán <Text strong style={{ color: "#333", fontSize: 12 }}>{book?.sold_quantity?.toLocaleString()}</Text>
//                     </Text>
//                 </Space>
...
//                             <Text strong style={{ fontSize: 20, color: "#e53935", lineHeight: 1 }}>
